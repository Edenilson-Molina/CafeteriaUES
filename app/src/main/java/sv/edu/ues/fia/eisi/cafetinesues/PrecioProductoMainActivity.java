...
public class PrecioProductoMainActivity extends ListActivity {

    String[] menu = {"Insertar Registro","Eliminar Registro",
            "Consultar Registro","Actualizar Registro"};
    String[] activities = {"PrecioProductoInsertarActivity","PrecioProductoEliminarActivity",
            "PrecioProductoConsultarActivity","PrecioProductoActualizarActivity"};
