...
public class PrecioProductoInsertarActivity extends Activity {
    ControlDB helper;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_precio_producto_insertar);
    ...
    public void insertarPrecioProducto(View v)
    {
        try {
            ...
            String registro;
            helper.abrir();
            registro = helper.insertar(precioProducto);
            helper.cerrar();
